...
//	{
//		cout << "Векторы разных размеров! (будет возращёна нулевая строка)" << endl << endl;
...
//	{
//		cout << "Векторы разных размеров! (будет возращён нулевой столбец)" << endl << endl;
...
//	{
//		cout << "Матрицы разных размеров! (будет возращена нулевая матрица)" << endl << endl;
//		return ErrorMatrix;
//	}
//
...
//	if (Row_1.GetRowSize() != Row_2.GetRowSize())
//	{
//		cout << "Невозможно произвести разность данных векторов! (будет возращёна нулевая строка)" << endl << endl;
//		return ErrorVectorRow;
//	}
//
//	for (int i = 0; i < Row_1.GetRowSize(); i++)
...
//	if (Column_1.GetColumnSize() != Column_2.GetColumnSize())
//	{
//		cout << "Невозможно произвести разность данных векторов! (будет возращён нулевой столбец)" << endl << endl;
//		return ErrorVectorColumn;
//	}
//
//	for (int i = 0; i < Column_1.GetColumnSize(); i++)
...
//	if (Matrix_1.GetColumnSize() != Matrix_2.GetColumnSize() || Matrix_1.GetRowSize() != Matrix_2.GetRowSize())
//	{
//		cout << "Невозможно произвести разность данных матриц! (будет возращена нулевая матрица)" << endl << endl;
//		return ErrorMatrix;
//	}
//
//	for (int i = 0; i < Matrix_1.GetColumnSize(); i++)
...
//	{
//		cout << "Такие векторвы не могут быть умножены! (будет возращена нуливая матрица)" << endl << endl;
//		return ErrorMatrix;
//	}
//
//	for (int i = 0; i < Matrix_1.GetColumnSize(); i++)
...
//	{
//		cout << "Такие векторы не могут быть умножены! (будет возращена -1)" << endl << endl;
//		return ErrorDouble;
//	}
//
...
//	{
//		cout << "Матрицы разных размеров! (будет возращена нулевая строка)" << endl << endl;
//
//		return ErrorVectorRow;
//	}
//
...
//	if (Value == 0)
//	{
//		cout << "На ноль делить нельзя! (будет возращена нулевая строка)" << endl << endl;
//		return ErrorVectorRow;
//	}
//
//	for (int i = 0; i < Row.GetRowSize(); i++)
...
//	if (Value == 0)
//	{
//		cout << "На ноль делить нельзя! (будет возращён нулевой столбец)" << endl << endl;
//		return ErrorVectorColumn;
//	}
//
//	for (int i = 0; i < Column.GetColumnSize(); i++)
...
//	if (Value == 0)
//	{
//		cout << "На ноль делить нельзя! (будет возращена нулевая матрица)" << endl << endl;
//		return ErrorMatrix;
//	}
//
